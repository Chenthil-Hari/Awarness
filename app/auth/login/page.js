      ...
      <div className="panel-wrap">
        ...
        <div className="panel">
          ...
          <div className="logo-row">
            ...
            <div className="logo-text">SECURE ACCESS</div>
          </div>
          <div className="subtitle">Authentication Required — v4.1.7</div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="options-row">
              ...
              <a href="#" className="forgot">Forgot credentials?</a>
            </div>
          ...
          <div className="switch-link">
            Unauthorized? <Link href="/auth/signup">Initialize Account</Link>
          </div>
        </div>
